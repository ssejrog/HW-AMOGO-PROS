...
const int  L_CHASSIS_PORTS[MOTORS_PER_SIDE] = {-13, -11}; // Ports, the first number will be used for sensing
const int  R_CHASSIS_PORTS[MOTORS_PER_SIDE] = {14, 21}; // Ports, the first number will be used for sensing
...
const float RATIO			= 0.6;   // External drive ratio (MUST BE DECIMAL)
